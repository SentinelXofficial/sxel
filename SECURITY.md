...
If you discover a security vulnerability in sxel itself (not a vulnerability found by sxel on a target), please report it privately:
...
sxel is a security testing tool. By using it, you agree to:

1. Only test systems you own or have explicit written authorization to test
2. Comply with all applicable laws and regulations
3. Not use sxel for unauthorized access, denial of service, or any illegal activity

The maintainers assume no liability for misuse of this software.

## Bug Bounty

We welcome reports of vulnerabilities in sxel itself through our security contact. At this time we do not offer a paid bug bounty program, but we will publicly acknowledge your contribution in:
- The release notes
